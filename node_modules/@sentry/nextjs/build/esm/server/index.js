...
import { SEMATTRS_HTTP_TARGET, SEMATTRS_HTTP_METHOD, SEMATTRS_HTTP_ROUTE } from '@opentelemetry/semantic-conventions';
...
export { experimental_captureRequestError } from '../common/captureRequestError.js';
...
function init(options) {
  ...
  _optionalChain([client, 'optionalAccess', _4 => _4.on, 'call', _5 => _5('spanStart', span => {
    ...
    if (_optionalChain([spanAttributes, 'optionalAccess', _6 => _6['next.route']])) {
      ...
      if (_optionalChain([rootSpanAttributes, 'optionalAccess', _7 => _7[SEMATTRS_HTTP_METHOD]]) && !_optionalChain([rootSpanAttributes, 'optionalAccess', _8 => _8[SEMATTRS_HTTP_ROUTE]])) {
    ...
    Object.assign(
      (event => {
        if (event.type === 'transaction') {
          ...
          if (
            (_optionalChain([event, 'access', _14 => _14.contexts, 'optionalAccess', _15 => _15.trace, 'optionalAccess', _16 => _16.data, 'optionalAccess', _17 => _17[SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN]]) === 'auto.http.otel.http' ||

'use client';
import { useAddReaction, useRemoveReaction, useSelf, useDeleteComment, useEditComment, useMarkThreadAsRead } from '@liveblocks/react';
  ...
  const tooltipContent = useMemo(
    () => /* @__PURE__ */ React__default.createElement("span", null, $.COMMENT_REACTION_LIST(
      /* @__PURE__ */ React__default.createElement(List, {
        values: reaction.users.map((users, index) => /* @__PURE__ */ React__default.createElement(User, {
          key: users.id,
          userId: users.id,
          capitalize: index === 0,
          replaceSelf: true
...
const Comment = forwardRef(
  ({
    ...
    }))))), comment.userId === self?.id && /* @__PURE__ */ React__default.createElement(Dropdown, {
